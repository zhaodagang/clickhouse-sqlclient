...
export default class Query extends Component {
  ...
  //   const plotlyJSON = {
  //     data:[{marker:{color:"#19d3f3",line:{width:1},size:6},mode:"lines",name:"age",type:"line",x:[],y:[]}]
  // }
            ...
            <Col span={24} style={{ backgroundColor: '#EEE', width: '100%', zIndex: '10000' }}>
              ...
              <Tabs defaultActiveKey="1" style={{ height: '100%' }}>
                ...
                <TabPane tab="Table View" key="1">
                  ...
                  <Scrollbars style={{ height: 'auto', minHeight: '40vh' }}>
                ...
                <TabPane tab="JSON Result" key="2">
                  <Scrollbars style={{ height: 'auto', minHeight: '60vh' }}>
